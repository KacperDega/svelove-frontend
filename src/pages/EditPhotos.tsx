...
const EditPhotos = () => {
  ...
  const [loading, setLoading] = useState(false); // TODO: true when fetching existing photos
    ...
    <div className="min-h-screen bg-base-100">
      ...
      <div className="max-w-2xl mx-auto p-6">
        <div className="card bg-neutral shadow-xl mt-6 p-6 space-y-6">
          ...
          <div className={`flex justify-between space-x-2 ${saving ? "opacity-65 cursor-not-allowed pointer-events-none" : ""}`}>
            <button
