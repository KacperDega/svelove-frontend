...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="border-b border-secondary fixed bottom-0 left-0 right-0 flex items-center justify-between h-[73px] px-4 text-sm shadow bg-neutral z-50
                    md:relative md:top-0 md:z-10 md:px-6">

      <div className="hidden md:block">
        <h1 className="object-contain font-teaspoon text-primary text-4xl select-none">svelove</h1>
      </div>
